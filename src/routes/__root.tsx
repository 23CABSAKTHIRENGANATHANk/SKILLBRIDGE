...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  console.error("[SkillBridge] Root error boundary:", error);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/skillbridge-logo.jpeg" },
      { property: "og:image:alt", content: "SkillBridge — Where Skills Meet Opportunity" },
      { name: "twitter:site", content: "@SkillBridge" },
      { name: "twitter:image", content: "/skillbridge-logo.jpeg" },
      { name: "twitter:image:alt", content: "SkillBridge — Where Skills Meet Opportunity" },
      {
        name: "twitter:title",
        content: "SkillBridge — Where Skills Meet Opportunity",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/skillbridge-logo.jpeg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/skillbridge-logo.jpeg" },
